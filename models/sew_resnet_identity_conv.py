...
__all__ = ['SEWResNet_identity_conv', 
           
           'sew_resnet18_identity_conv', 
           'sew_resnet34_identity_conv', 
           'sew_resnet50_identity_conv', 
           'sew_resnet101_identity_conv', 
           'sew_resnet152_identity_conv',
           
           'sew_resnext50_32x4d_identity_conv', 
           'sew_resnext50_32x8d_identity_conv', 
           'sew_resnext50_32x16d_identity_conv', 
           'sew_resnext50_32x32d_identity_conv',
           
           'sew_resnext101_32x8d_identity_conv',
           'sew_wide_resnet50_2_identity_conv', 
           'sew_wide_resnet101_2_identity_conv']
...
class SEWResNet_identity_conv(nn.Module):
...
def _sew_resnet(arch, block, layers, pretrained, progress, cnf, spiking_neuron, **kwargs):
    model = SEWResNet_identity_conv(block, layers, cnf=cnf, spiking_neuron=spiking_neuron, **kwargs)
    return model


def sew_resnet18_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):

    return _sew_resnet('resnet18', SEW_BasicBlock_conv1x1_identity, [2, 2, 2, 2], pretrained, progress, cnf, spiking_neuron, **kwargs)


def sew_resnet34_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):

    return _sew_resnet('resnet34', SEW_BasicBlock_conv1x1_identity, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)


def sew_resnet50_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):

    return _sew_resnet('resnet50', SEW_Bottleneck_conv1x1_identity, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)


def sew_resnet101_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):

    return _sew_resnet('resnet101', SEW_Bottleneck_conv1x1_identity, [3, 4, 23, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)


def sew_resnet152_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):

    return _sew_resnet('resnet152', SEW_Bottleneck_conv1x1_identity, [3, 8, 36, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)


def sew_resnext50_32x4d_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):
...
def sew_resnext50_32x8d_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):

    kwargs['groups'] = 32
    kwargs['width_per_group'] = 8
    return _sew_resnet(None, SEW_Bottleneck_conv1x1_identity, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)

def sew_resnext50_32x16d_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):

    kwargs['groups'] = 32
    kwargs['width_per_group'] = 16
    return _sew_resnet(None, SEW_Bottleneck_conv1x1_identity, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)

def sew_resnext50_32x32d_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):
...
def sew_resnext101_32x8d_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):
...
def sew_wide_resnet50_2_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):
...
def sew_wide_resnet101_2_identity_conv(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable=None, **kwargs):
