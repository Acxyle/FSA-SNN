...
class ResNet_identity_conv(ResNet_Base):
...
def _resnet(
    ...
    **kwargs: Any,
    ...
    model = ResNet_identity_conv(block, layers, **kwargs)

    return model


# ---
def resnet18_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
    return _resnet(BasicBlock_conv1x1_identity, [2, 2, 2, 2], **kwargs)


def resnet34_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
    return _resnet(BasicBlock_conv1x1_identity, [3, 4, 6, 3], **kwargs)


def resnet50_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
    return _resnet(Bottleneck_conv1x1_identity, [3, 4, 6, 3], **kwargs)


def resnet101_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
    return _resnet(Bottleneck_conv1x1_identity, [3, 4, 23, 3], **kwargs)


def resnet152_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
    return _resnet(Bottleneck_conv1x1_identity, [3, 8, 36, 3], **kwargs)


# ---
def resnext50_32x4d_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
...
def resnext50_32x8d_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
...
def resnext50_32x16d_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
...
def resnext50_32x32d_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
...
# ---
def resnet20_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
    return _resnet_lite(BasicBlock_conv1x1_identity, [3, 3, 3], **kwargs)


def resnet38_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
    return _resnet_lite(BasicBlock_conv1x1_identity, [6, 6, 6], **kwargs)


def resnet56_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
    return _resnet_lite(BasicBlock_conv1x1_identity, [9, 9, 9], **kwargs)


def resnet110_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
    return _resnet_lite(BasicBlock_conv1x1_identity, [18, 18, 18], **kwargs)


def resnet164_identity_conv(**kwargs: Any) -> ResNet_identity_conv:
